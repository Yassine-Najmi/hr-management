    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-body">
                ...
                <!-- Vertical Form -->
                <form wire:submit.prevent="add_post" class="row g-3" action="" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="col-6">
                        <label for="name" class="form-label">First Name<span class="text-danger"> *</span></label>
                        <input wire:model="name" type="text" value="{{ old('name') }}" name="name"
                            class="form-control" id="name">
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                    </div>
                    <div class="col-6">
                        <label for="last_name" class="form-label">Last Name<span class="text-danger"> *</span></label>
                        <input wire:model="last_name" type="text" value="{{ old('last_name') }}" name="last_name"
                            class="form-control" id="last_name">
                        <span class="text-danger">{{ $errors->first('last_name') }}</span>
                    </div>
                    <div class="col-6">
                        <label for="email" class="form-label">Email<span class="text-danger"> *</span></label>
                        <input wire:model="email" type="email" value="{{ old('email') }}" name="email"
                    ...
                    <div class="col-6">
                        <label for="phone_number" class="form-label">Phone Number<span class="text-danger">
                                *</span></label>
                        <input wire:model="phone_number" type="text" value="{{ old('phone_number') }}"
                            name="phone_number" class="form-control" id="phone_number">
                        <span class="text-danger">{{ $errors->first('phone_number') }}</span>
                    </div>
                    <div class="col-6">
                        <label for="hire_date" class="form-label">Hire Date<span class="text-danger"> *</span></label>
                        <input wire:model="hire_date" type="date" value="{{ old('hire_date') }}" name="hire_date"
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            <select wire:model="job_id" class="form-select" name="job_id" id="job_id">
                    ...
                    <div class="col-6">
                        ...
                        <input wire:model="salary" type="number" value="{{ old('salary') }}" name="salary"
                    ...
                    <div class="col-6">
                        <label for="commission_pct" class="form-label">Commission PCT<span class="text-danger">
                                *</span></label>
                        <input wire:model="commission_pct" type="number" value="{{ old('commission_pct') }}"
                            name="commission_pct" class="form-control" id="commission_pct">
                        <span class="text-danger">{{ $errors->first('commission_pct') }}</span>
                    </div>
                    <div class="col-6">
                        <label for="manager_id" class="form-label">Manager Name<span class="text-danger">
                                *</span></label>
                        <div class="col-12">
                            <select wire:model="manager_id" class="form-select" name="manager_id" id="manager_id">
                    ...
                    <div class="col-6">
                        <label for="department_id" class="form-label">Dapartment Name<span class="text-danger">
                                *</span></label>
                        <div class="col-12">
                            <select wire:model="department_id" class="form-select" name="department_id"
                                id="department_id">
