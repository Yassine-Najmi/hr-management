                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">
                                        {{ !empty($user->job->job_title) ? $user->job->job_title : '' }}</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ date('d/m/Y H:i', strtotime($user->created_at)) }}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ date('d/m/Y H:i', strtotime($user->updated_at)) }}
                                    </div>
                                </div>
                            </div>
