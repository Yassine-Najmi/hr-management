        ...
        <div class="card-body">
          ...
          <form class="row g-3" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="col-6">
                ...
                <input type="text" value="{{old('phone_number')}}" name="phone_number" class="form-control" id="phone_number">
                <span class="text-danger">{{$errors->first('phone_number')}}</span>
            </div>
            <div class="col-6">
                <label for="hire_date" class="form-label">Hire Date<span class="text-danger"> *</span></label>
                <input type="date" value="{{old('hire_date')}}" name="hire_date" class="form-control" id="hire_date">
            ...
            <div class="col-6">
                ...
                <input type="number" value="{{old('salary')}}" name="salary" class="form-control" id="salary">
                <span class="text-danger">{{$errors->first('salary')}}</span>
            </div>
            <div class="col-6">
                <label for="commission_pct" class="form-label">Commission PCT<span class="text-danger"> *</span></label>
                <input type="number" value="{{old('commission_pct')}}" name="commission_pct" class="form-control" id="commission_pct">
            ...
            <div class="col-6">
                <label for="department_id" class="form-label">Dapartment Name<span class="text-danger"> *</span></label>
                <div class="col-12">
